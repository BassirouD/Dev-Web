...
e_commerce_app API
- API version: 1.0.0
  - Build date: 2024-06-12T00:45:41.473600400+02:00[Europe/Paris]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**createOrder**](docs/DefaultApi.md#createOrder) | **POST** /api/v1/orders | POST api/v1/orders
